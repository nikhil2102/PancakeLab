...
import org.nikhilesh.pancakelab.model.pancakes.Pancake;
...
public class OrderLog {
    ...
    public static void logRemovePancakes(Order order, String description, int count, List<Pancake> pancakes) {
        long pancakesInOrder = pancakes.stream().filter(p -> p.getOrderId().equals(order.getId())).count();
